...
var Biu = function () {
  ...
  _createClass(Biu, [{
    ...
    value: function draw(barrage) {
      ...
      var duration = barrage.duration || this.duration * Math.random();
      ...
      dom.addEventListener('animationend', function () {
        _this2.container.removeChild(dom);
      }, false);
    ...
    value: function setRandomInterval(fn, defaultQueueInterval) {
      var _this3 = this;

      this.stopRandomRun = false;
      var loop = function loop() {
        if (_this3.stopRandomRun) return;
        var interval = Math.round(Math.random() * defaultQueueInterval);
        setTimeout(function () {
          fn();
          loop();
        }, interval);
    ...
    key: 'startDefaultQueue',
    value: function startDefaultQueue() {
      var _this4 = this;

      if (this.defaultQueue.length > 0) {
        this.setRandomInterval(function () {
          _this4.draw(_this4.defaultQueue[Math.round(Math.random() * (_this4.defaultQueue.length - 1))]);
    ...
    value: function start() {
      ...
      this.visibleChangeEvt = function () {
        _this5.pause();
      };
